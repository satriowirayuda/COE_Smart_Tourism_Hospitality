...
<body>
    ...
    <section class="mx-auto px-10 pt-28 pb-20">
    <x-white-navigation />
            ...
            <div class="flex flex-wrap mt-7 gap-4">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a class="text-lg font-light underline underline-offset-4 text-cyan-500" target="_blank" href="https://doi.org/10.62951/momat.v1i3.32">
