    ...
    <x-white-navigation />
        ...
        <div class="relative w-full h-[181px] md:[300px] lg:h-[350px] px-4 lg:px-28 mx-auto">
            <img class="w-full h-full object-cover rounded-[40px]"
                src="{{ asset('assets/binno.png') }}" alt="">
            <div class="absolute inset-0 flex flex-col justify-center items-center text-white">
                <div class="text-center font-extralight">
                    <p class="font-lota2 text-2xl md:text-4xl lg:text-6xl font-bold">Innovillage</p>
                    <p class="font-lota1 text-base md:text-3xl lg:text-3xl italic">Center of Excellence Smart Tourism & Hospitality</p>
                </div>
            </div>
        </div>
