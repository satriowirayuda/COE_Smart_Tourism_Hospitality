...
<body>
    <div class="flex bg-white rounded-[40px] h-14 mx-[110px] shadow-2xl my-10 pl-20 items-center gap-9 text-sm font-semibold text-black">
        <a href="#" class="text-[#025D9F]">Semua</a>
    ...
    <section class="mx-[110px] mb-28 space-y-5">
        <div class="flex gap-4">
            <img src="{{ asset('assets/artikel-2.png')}}" alt="artikel" 
                class="w-[350px] h-[200px] object-cover rounded-[30px] shadow-2xl">
            ...
            <div class="bg-white shadow-2xl rounded-2xl px-7 py-4"> 
                ...
                <div class="flex gap-2">
                    ...
                    <div class=" text-center content-center text-xs font-light border border-[#D9D9D9] w-20 h-8 rounded-md">
