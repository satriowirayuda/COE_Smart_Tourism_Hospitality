...
<body> 
    ...
    <x-white-navigation />
        ...
        <div class="relative w-full h-52 md:h-[300px] lg:h-[446px] px-5 lg:px-28 mx-auto">
            ...
            <div class="absolute top-4 left-10 md:left-10 lg:left-40 bg-biru-sth w-24 md:w-28 lg:w-36 h-6 md:h-7 lg:h-8 text-center content-center rounded-md md:rounded-md lg:rounded-lg text-white font-semibold text-[10px] md:text-xs lg:text-base font-lota1">
                <p>Berita Terkini</p>
            </div>
                
            <div class="absolute text-white left-10 md:left-10 lg:left-40 bottom-5 md:bottom-10 lg:bottom-10 space-y-3">
                <div class="flex gap-1 items-center justify-center bg-[#D9D9D9] bg-opacity-25 w-[105px] md:w-[140px] lg:w-[154px] h-[20px] md:h-[30px] lg:h-[35px] rounded-md md:rounded-lg lg:rounded-xl">
                    <img class="w-4 md:lg:w-6" src="{{ asset('assets/calender.svg') }}" alt="">
                    <p class="font-lota1 text-[8px] md:text-xs lg:text-xs font-semibold">21, December 2023</p>
                </div>
                <div class="mr-20 font-lota2 font-bold text-[8px] md:text-sm lg:text-base">
