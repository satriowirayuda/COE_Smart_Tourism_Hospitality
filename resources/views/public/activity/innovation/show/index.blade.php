<x-guest-layout>
    ...
    <div>
        ...
        <main class="flex min-h-[100vh] flex-col items-center pt-[100px]">
            ...
            <div class="h-[400px] w-full md:h-[600px] md:w-full">
              <div class="h-[80%]">
                <img
                  ...
                  src=""
                  alt="img"
                  class="h-full w-full bg-gray-300 object-cover opacity-0 transition-opacity duration-1000 ease-in-out"
                />
              </div>
              <div
                class="mt-5 flex h-[20%] gap-1 overflow-y-hidden overflow-x-scroll py-1 scrollbar-none"
              >
                @foreach ($innovation->photos as $photo)
                  <img
                    class="thumbnail h-[100%] w-[160px] cursor-pointer bg-gray-300 transition duration-500 hover:scale-110"
          ...
          {{-- Kategori & Klien --}}
          <div class="mt-10 flex w-11/12 md:w-5/6">
            <div>
              <p class="text-lg font-semibold text-orange1">Kategori :</p>
              <span>{{ $innovation->category }}</span>
            </div>
            <div class="ms-20">
              <p class="text-lg font-semibold text-orange1">Klien :</p>
              <span>{{ $innovation->client }}</span>
            </div>
          </div>
          ...
          <div class="my-5 w-11/12 md:w-5/6">
            ...
            <div>
              ...
              <p class="text-justify">{{ $innovation->description }}</p>
            </div>
            {{-- paragraf 2 --}}
            <div class="mt-5">
          ...
          <div class="my-10 flex w-11/12 flex-col items-center md:w-5/6">
            ...
            <div class="flex flex-wrap justify-center">
              @foreach ($innovation->mitra_logos as $mitra)
                <img
