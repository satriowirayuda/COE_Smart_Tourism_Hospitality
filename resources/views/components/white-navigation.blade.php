    ...
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-6">
            ...
            <div class="relative dropdown">
                ...
                <div class="dropdownMenu absolute hidden bg-white text-black right-0 mt-2 rounded-xl shadow-lg">
            ...
            <div class="relative dropdown">
                ...
                <div class="dropdownMenu absolute hidden bg-white text-black right-0 mt-2 rounded shadow-lg">
                    ...
                    <a href="/inovasidash" class="block px-6 py-2 hover:bg-gray-200">Innovasi</a>
                    <a href="/bisnisdash" class="block px-6 py-2 hover:bg-gray-200">Bisnis</a>
                </div>
            </div>
