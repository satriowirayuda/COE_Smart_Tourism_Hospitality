<nav id="navbar" class="fixed top-0 left-0 right-0 z-20 w-full bg-transparent p-4 transition-all duration-300">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-6">
            <a href="/" class="text-gray-300 hover:text-[#F6A11F] active:text-[#F6A11F] focus:text-[#F6A11F] {{ request()->is('/') ? 'text-[#F6A11F]' : '' }}">Beranda</a>

            <!-- Dropdown Tentang Kami -->
            <div class="relative dropdown">
                <button class="dropdownButton text-gray-300 px-8 hover:text-[#F6A11F] active:text-[#F6A11F] focus:text-[#F6A11F] {{ request()->is('sejarah', 'anggota') ? 'text-[#F6A11F]' : '' }}">
                    Tentang Kami
            ...
            <!-- Dropdown Aktivitas -->
            <div class="relative dropdown">
                <button class="dropdownButton text-gray-300 px-8 hover:text-[#F6A11F] active:text-[#F6A11F] focus:text-[#F6A11F]">
                    Aktivitas
                    <svg class="w-5 h-5 inline ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                ...
                <div class="dropdownMenu absolute hidden bg-white text-black right-0 mt-2 rounded shadow-lg">
                    ...
                    <a href="/riset-publikasi/dashboard" class="block px-6 py-2 hover:bg-gray-200">Riset dan Publikasi</a>
                    <a href="/innovillage/dashboard" class="block px-6 py-2 hover:bg-gray-200">Innovasi</a>
                    <a href="#" class="block px-6 py-2 hover:bg-gray-200">Pengabdian Masyarakat</a>
            ...
            <!-- Dropdown Program -->
            <div class="relative dropdown">
                <button class="dropdownButton text-gray-300 px-8 hover:text-orange-500 focus:outline-none">
                    Program
                    <svg class="w-5 h-5 inline ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
