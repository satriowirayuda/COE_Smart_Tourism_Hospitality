<x-app-layout>
    <div>
        <div class="flex justify-between">
            <div class="">
                <h1 class="text-2xl font-semibold">Tambah Project Terkini</h1>
                <p class="text-sm font-medium">Isi Konten untuk tambah project :</p>
            </div>
        ...
        <form action="{{ route('admin.project.store') }}" method="POST" class="mt-5">
            ...
            <button type="submit"
                class="w-full rounded-lg bg-yellow1 px-5 py-2 text-base font-medium text-white hover:bg-yellow-400 focus:outline-none focus:ring-4 focus:ring-yellow-300 md:w-4/12">
                Simpan Project
            </button>
        </form>
    </div>
