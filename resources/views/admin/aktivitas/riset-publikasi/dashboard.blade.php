        ...
        <div class="flex overflow-hidden">
            ...
            <div class="px-10 py-10 w-full">
                ...
                <div class="pt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
                    ...
                    <!-- Card 1 -->
                    <a href="/innovillage" class="block">
                        <div class="bg-white shadow-md rounded-lg overflow-hidden items-center">
                            ...
                            <div class="p-4 bg-white">
                                <h3 class="font-semibold text-xl mb-2 text-center text-shadow-xl">Innovillage</h3>
                    ...
                    <!-- Card 2 -->
                    <a href="/jurnal" class="block">
                        <div class="bg-white shadow-md rounded-lg overflow-hidden items-center">
                            <div class="flex bg-white items-center justify-center h-36 w-full">
                                <img src="{{ asset('assets/jurnal.svg') }}" alt="Card Image" class="object-contain">
                            </div>
                            <div class="p-4 bg-white">
                                <h3 class="font-semibold text-xl mb-2 text-center text-shadow-xl">Penelitian Jurnal
                                </h3>
