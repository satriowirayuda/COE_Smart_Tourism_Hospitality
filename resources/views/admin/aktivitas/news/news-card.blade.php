<x-app-layout>
    <div class="col-span-3 overflow-hidden rounded-3xl border-2 p-4">
        <div class="lg:flex lg:flex-row-reverse lg:gap-x-1.5">
            <div
                class="relative h-32 w-full overflow-hidden rounded-md lg:h-20 lg:basis-6/12">
                <img
                    class="h-full min-h-full w-full min-w-full bg-gray-300 object-cover"
                    src="{{ $news->photo_url }}"
                    alt="News Image" />
            </div>
            <div class="my-auto lg:basis-6/12">
                <h5 class="line-clamp-3 text-base font-bold text-gray-900 lg:text-xs">
                    {{ $news->title }}
                </h5>
            </div>
        </div>
        <div class="text-base">
            ...
            <p class="text-gray-500">{{ $news->category->name }}</p>
        </div>
            ...
            <div class="relative max-h-full w-full max-w-md p-4">
                <div class="relative rounded-lg bg-white shadow">
                    <button
                        ...
                        data-modal-hide="delete-modal-{{ $news->id }}">
                        <svg
                            class="h-3 w-3"
                            aria-hidden="true"
