<x-app-layout>
    <div
        ...
        <div
            class="relative h-32 min-h-32 w-full overflow-hidden rounded-lg lg:h-20 lg:min-h-20 lg:basis-5/12">
            <img
        ...
        <div class="text-base">
            <p class="line-clamp-1 font-bold text-gray-900">{{ $journal->title }}</p>
            <p class="line text-gray-500">
        ...
        <div class="mt-2 flex justify-end space-x-1">
            ...
            <a
                href="{{ route("admin.journal.edit", ["journal" => $journal->id]) }}"
