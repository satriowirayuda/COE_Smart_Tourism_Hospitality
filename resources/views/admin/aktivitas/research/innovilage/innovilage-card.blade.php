<x-app-layout>
    <div
        ...
        <div
            class="lg:basis-12/12 relative mb-2 min-h-32 w-full overflow-hidden rounded-md lg:min-h-20">
            <img
        ...
        <div class="mt-2 flex justify-end space-x-1">
            <button
                data-modal-target="delete-modal-{{ $innovillage->id }}"
                data-modal-toggle="delete-modal-{{ $innovillage->id }}"
            ...
            <a
                href="{{ route("admin.innovillage.edit", ["innovillage" => $innovillage->id]) }}"
        ...
        <div
            id="delete-modal-{{ $innovillage->id }}"
            tabindex="-1"
            ...
            <div class="relative max-h-full w-full max-w-md p-4">
                <div class="relative rounded-lg bg-white shadow">
                    <button
                        ...
                        data-modal-hide="delete-modal-{{ $innovillage->id }}">
                        <svg
                            class="h-3 w-3"
                            aria-hidden="true"
