        ...
        <div class="flex overflow-hidden">
            ...
            <div class="px-10 py-10 w-full">
                ...
                <div class="pt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
                    ...
                    <a href="/pelatihan" class="block">
                        <div class="bg-white shadow-md rounded-lg overflow-hidden items-center">
                            <div class="flex bg-white items-center justify-center h-36 w-full">
                                <img src="{{ asset('assets/pelatihan.svg') }}" alt="Card Image" class="object-contain">
                            </div>
                            <div class="p-4 bg-white">
                                <h3 class="font-semibold text-xl mb-2 text-center text-shadow-xl">Pelatihan</h3>
                    ...
                    <!-- Card 2 -->
                    <a href="/kedai" class="block">
                        <div class="bg-white shadow-md rounded-lg overflow-hidden items-center">
                            <div class="flex bg-white items-center justify-center h-36 w-full">
                                <img src="{{ asset('assets/kedai.svg') }}" alt="Card Image" class="object-contain">
                            </div>
                            <div class="p-4 bg-white">
                                <h3 class="font-semibold text-xl mb-2 text-center text-shadow-xl">Kedai CoE
                                </h3>
