<x-app-layout>
    <div>
        <div class="flex justify-between">
            <div class="">
                <h1 class="text-2xl font-semibold">Tambah Inovasi</h1>
                <p class="text-sm font-medium">Isi Konten untuk tambah Inovasi :</p>
            </div>
            <a
                href="{{ route("admin.innovation.index") }}"
        ...
        <form action="{{ route('admin.innovation.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <div class="rounded-lg bg-blue1 p-4">
                            <div class="min-h-40" id="mitra-logos-preview">
                                <div class="grid min-h-40 place-items-center" id="mitra-logos-placeholder">
                                ...
                                <div class="mt-2 hidden grid-cols-5 gap-2 md:grid-cols-8" id="mitra-logos-grid">
                                </div>
                            </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="rounded-lg bg-blue1 p-4">
                            <div class="min-h-40" id="photos-preview">
                                <div class="grid min-h-40 place-items-center" id="photos-placeholder">
                                    <p class="text-base font-medium text-gray-500">
                                        Max 6 Dokumentasi
                                    </p>
                                </div>
                                <div class="mt-2 hidden grid-cols-3 gap-1" id="photos-grid">
                                </div>
                            </div>
                            <div class="mt-5 w-full text-end">
                                <label
