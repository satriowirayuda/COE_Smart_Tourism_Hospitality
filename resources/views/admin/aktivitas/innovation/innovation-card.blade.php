<x-app-layout>
    <div class="col-span-3 overflow-hidden rounded-3xl border-2 p-4">
        <div class="lg:flex lg:flex-row-reverse lg:gap-x-2">
            <div
                ...
                <img
                    ...
                    src="{{ $innovation->first_photo->photo_url }}"
                    alt="Article Image" />
            </div>
        ...
        <div class="flex justify-end space-x-1">
            <button
                data-modal-target="delete-modal-{{ $innovation->id }}"
                data-modal-toggle="delete-modal-{{ $innovation->id }}"
            ...
            <a
                href="{{ route("admin.innovation.edit", ["innovation" => $innovation->id]) }}"
            ...
            <div class="relative max-h-full w-full max-w-md p-4">
                <div class="relative rounded-lg bg-white shadow">
                    <button
                        ...
                        data-modal-hide="delete-modal-{{ $innovation->id }}">
                        <svg
                            class="h-3 w-3"
                            aria-hidden="true"
