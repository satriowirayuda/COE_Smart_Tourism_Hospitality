<x-app-layout>
    <div class="col-span-3 overflow-hidden rounded-3xl border-2 p-4">
        <div
            class="relative mb-2 h-32 w-full overflow-hidden rounded-lg lg:h-20 lg:basis-5/12">
            <img
        ...
        <div class="mt-3 flex justify-evenly space-x-2 md:px-4">
            <button
                data-modal-target="delete-modal-{{ $shop->id }}"
                data-modal-toggle="delete-modal-{{ $shop->id }}"
            ...
            <div class="relative max-h-full w-full max-w-md p-4">
                <div class="relative rounded-lg bg-white shadow">
                    <button
                        ...
                        data-modal-hide="delete-modal-{{ $shop->id }}">
                        <svg
                            class="h-3 w-3"
                            aria-hidden="true"
