<x-app-layout>
    <div>
        <div class="flex justify-between">
            <div class="">
                <h1 class="text-2xl font-semibold">Tambah Pelatihan</h1>
                <p class="text-sm font-medium">Isi Konten untuk tambah Pelatihan :</p>
            </div>
            <a
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex w-full items-center justify-center">
                            <label
                                ...
                                <div id="preview" class="absolute h-full w-full rounded-lg hidden">
                                    <img id="preview-image" src="#" alt="Preview"
                                        class="h-full w-full rounded-lg object-cover" />
                                </div>
                                <div id="placeholder"
                                    class="flex flex-col items-center justify-center rounded-lg pb-6 pt-5">
                                    <svg
                                        class="h-8 w-8"
                                        aria-hidden="true"
