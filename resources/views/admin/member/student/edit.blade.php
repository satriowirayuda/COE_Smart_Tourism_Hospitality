<x-app-layout>
    <div>
        ...
        <form action="{{ route('admin.student-member.update', $member) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <div class="col-span-full md:col-span-3">
                            ...
                            <div class="mt-1 flex w-full items-center justify-start md:justify-center">
                                <label for="photo"
                                    ...
                                    <div id="upload_icon"
                                        class="z-10 flex flex-col items-center justify-center text-gray-900 {{ $member->photo ? 'hidden' : '' }}">
                        ...
                        <div class="col-span-full md:col-span-12 md:grid md:grid-cols-2 md:gap-x-12 lg:mt-5">
                            ...
                            <div class="mb-6">
                                ...
                                <select
                                    ...
                                    <option value="inhouse" {{ old('status', $member->status) == 'inhouse' ? 'selected' : '' }}>Inhouse</option>
