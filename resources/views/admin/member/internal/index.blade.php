<x-app-layout>
    <div>
        <div class="flex justify-between">
            <div class="">
                <h1 class="text-2xl font-semibold">Managemen Konten Anggota Internal</h1>
        ...
        <div class="mt-3 flex justify-between">
            <a
                href="{{ route("admin.internal-member.create") }}"
            ...
            <div class="mt-5 grid grid-cols-3 gap-3 md:grid-cols-6 lg:grid-cols-9">
                ...
                <div class="col-span-3 overflow-hidden rounded-3xl border-2 p-4">
                    ...
                    <div class="mt-2 flex justify-evenly space-x-2 md:px-4">
                        <form action="{{ route('admin.internal-member.destroy', $member) }}" method="POST" class="w-full">
                            @csrf
                            @method('DELETE')
                            <button type="submit" 
                        ...
                        <a
                            href="{{ route('admin.internal-member.edit', $member) }}"
