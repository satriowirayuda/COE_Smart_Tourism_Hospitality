<x-app-layout>
    <div class="col-span-3 overflow-hidden rounded-3xl border-2 p-4">
        <div
            class="relative min-h-32 w-full overflow-hidden rounded-lg md:h-24 lg:min-h-24 lg:basis-6/12">
            <img
            ...
            <div class="relative max-h-full w-full max-w-md p-4">
                <div class="relative rounded-lg bg-white shadow">
                    <button
                        ...
                        data-modal-hide="delete-modal-{{ $member->id }}">
                        <svg
                            class="h-3 w-3"
                            aria-hidden="true"
                    ...
                    <div class="p-4 text-center md:p-5">
                        ...
                        <form action="{{ route('admin.internal-member.destroy', $member) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
                            <button
                                type="submit"
