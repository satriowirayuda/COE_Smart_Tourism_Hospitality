    ...
    <div>
        <div class="flex justify-between">
            <div class="">
                ...
                <p class="text-sm font-medium">Isi Konten untuk edit event :</p>
            </div>
            <a
                ...
                <div class="col-span-6">
                    ...
                    <div class="mb-6">
                        ...
                        <select
                            ...
                            <option value="lkm" {{ old('category', $timeline->category) == 'lkm' ? 'selected' : '' }}>LKM</option>
                            <option value="external" {{ old('category', $timeline->category) == 'external' ? 'selected' : '' }}>Eksternal</option>
                        </select>
                        @error('category')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
