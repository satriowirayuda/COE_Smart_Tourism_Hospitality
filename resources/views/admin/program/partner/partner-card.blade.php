<x-app-layout>
    <div class="col-span-3 overflow-hidden rounded-3xl border-2 p-4">
        ...
        <div class="mt-5 flex justify-evenly space-x-1 md:px-4">
            <button
                data-modal-target="delete-modal-{{ $partner->id }}"
                data-modal-toggle="delete-modal-{{ $partner->id }}"
            ...
            <a
                href="{{ route("admin.partner.edit", ["partner" => $partner->id]) }}"
            ...
            <div class="relative max-h-full w-full max-w-md p-4">
                <div class="relative rounded-lg bg-white shadow">
                    <button
                        ...
                        data-modal-hide="delete-modal-{{ $partner->id }}">
                        <svg
                            class="h-3 w-3"
                            aria-hidden="true"
