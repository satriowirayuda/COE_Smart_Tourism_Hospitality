<x-app-layout>
    <div>
        <div class="flex justify-between">
            <div class="">
                <h1 class="text-2xl font-semibold">Managemen Konten MBKM dan Magang</h1>
        ...
        <div class="mt-3 flex justify-between">
            <a
                href="{{ route('admin.intern.create') }}"
        ...
        <div class="mt-6">
            <form action="{{ route('admin.intern.index') }}" method="GET">
                <div class="relative">
                    <input
                        type="text"
                        name="search" 
            ...
            <div class="mt-5 grid grid-cols-3 gap-3 md:grid-cols-6 lg:grid-cols-9">
                ...
                <div class="col-span-3 overflow-hidden rounded-3xl border-2 p-4">
                    <div class="relative mb-4 h-32 w-full overflow-hidden rounded-lg lg:h-20 lg:basis-5/12">
                        <img
                    ...
                    <div class="mt-5 flex justify-evenly space-x-1 md:px-4">
                        <form action="{{ route('admin.intern.destroy', $intern) }}" method="POST" class="w-full">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
                        ...
                        <a
                            href="{{ route('admin.intern.edit', $intern) }}"
