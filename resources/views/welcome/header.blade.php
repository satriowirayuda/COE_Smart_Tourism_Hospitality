              ...
              <li class="group relative" aria-labelledby="dropdownResearchLink">
                ...
                <div
                  ...
                  <ul class="py-2 text-gray-700">
                    <li>
                      <a href="{{ route('innovillage') }}" class="block px-4 py-2 hover:bg-gray-100 hover:text-orange1">
                        Innovillage
                      </a>
                    </li>
                    <li>
                      <a href="{{ route('journal') }}" class="block px-4 py-2 hover:bg-gray-100 md:hover:text-orange1">
                        Jurnal Penelitian
                      </a>
                    </li>
                  </ul>
                ...
                <div id="researchDropdown"
                  ...
                  <ul class="p-2 text-gray-700">
                    ...
                    <li>
                      <a href="{{ route('journal') }}" class="block px-4 py-2 hover:bg-gray-100 hover:text-orange1">
                        Jurnal Penelitian
                      </a>
                    </li>
                  </ul>
