<section class="w-full bg-background py-10 lg:py-24 px-5 lg:px-28">
    <div class="lg:grid lg:grid-cols-3 gap-6 ">
        <div class="col-span-2">
            ...
            <div class="lg:pb-3">
                <p class="font-semibold text-lg sm:text-xl lg:text-4xl">Ketua</p>
                <p class="mt-3 font-semibold text-lg sm:text-xl lg:text-4xl">CoE Smart Tourism & Hospitality</p>
            </div>
    ...
    <div class="py-10 flex">
        <div class="mx-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-10 lg:pt-20">
            ...
            <div class="relative group flex justify-center">
                ...
                <a href="/risetdash" class="absolute inset-0"></a>
            </div>
            ...
            <div class="relative group flex justify-center">
                ...
                <a href="/inovasidash" class="absolute inset-0"></a>
            </div>
            <!-- Bisnis -->
            <div class="relative group flex justify-center">
                ...
                <a href="/bisnisdash" class="absolute inset-0"></a>
            </div>
