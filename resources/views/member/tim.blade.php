<section class="bg-background w-full pt-10 pb-28">
    <div class="px-4 md:px-10 lg:px-28">

        <p class="text-xl md:text-2xl font-semibold pb-10">Tim Magang Kami</p>

        <div
            class="bg-gradient-to-b from-[#2593CF] from-85% to-[#134B69] to-100% rounded-[40px] shadow-2xl pt-10 pb-16 px-4 md:px-10 lg:px-20">
            ...
            <div class="relative flex flex-col items-center justify-center pt-8">
                <div class="relative w-40 md:w-52 mx-auto">
                    ...
                    <div class="absolute bottom-0 w-full text-sm px-2 py-5 z-20">
            ...
            <!-- ANGGOTA COE -->
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 pt-10 gap-6 items-center mx-auto">
                <div class="relative w-40 md:w-52 mx-auto">
                    <div class="relative">
        ...
        <div
            class="bg-gradient-to-b from-[#FF8A00] from-85% to-[#995300] to-100% rounded-[40px] shadow-2xl pt-10 pb-16 px-4 md:px-10 lg:px-20">
