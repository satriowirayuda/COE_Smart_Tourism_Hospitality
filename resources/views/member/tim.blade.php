<section class="bg-background w-full pt-10 pb-28 font-lota1">
    <div class="px-5 md:px-10 lg:px-28">
        ...
        <div
            class="bg-gradient-to-b from-[#FF8A00] from-85% to-[#995300] to-100% rounded-[20px] sm:rounded-[30px] lg:rounded-[40px] shadow-2xl pt-10 pb-16 px-4 md:px-10 lg:px-20">
